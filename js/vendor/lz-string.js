/*!
 * LZ-String v1.4.5 (官方版) — https://github.com/pieroxy/lz-string
 *
 * 第三方库，原样搬运，禁止改动（改动后无法再用上游版本覆盖升级）。
 * 只保留页面用到的两个接口：compressToEncodedURIComponent / decompressFromEncodedURIComponent。
 *
 * 挂在全局 var LZString 上，供 js/codec.js 使用。
 */
